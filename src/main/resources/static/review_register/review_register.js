...
const reviewRegisterBtn = document.querySelector('.review__register__modal .review__register__content .review__register__btn')
const postIcon = document.querySelector('.review__register__modal .review__register__content .review__register__btn i')
...
const reviewRegisterModalCloseBtn = document.querySelector('.review__register__modal .review__modal__close__btn')
let selectedShow;
...
reviewRegisterBtn.addEventListener('click', () => {
    ...
    let show = {
        ...
        imgurl: selectedShow.poster_path 
    }
    let genres = [];
    ...
    axios.post(`http://${api_address}/api/review`, reviewPayload, header)
