...
let selectedShow;
const token = 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJqaW5oYTRldmVyQGdtYWlsLmNvbSIsImlhdCI6MTY1NDM0NDE2MiwiZXhwIjoxNjU0NDMwNTYyfQ.wVaDEEoJdtoynqZ8Ruz5ZZ0h5-t9W1-Q7c3xdFgy6Iu7SIWraYLD1qCRM1IJhqgq297WSA7GFKZZVaesEDZEFw';
...
reviewRegisterBtn.addEventListener('click', () => {
    ...
    axios.post('http://localhost:8080/api/review', reviewPayload, header)
